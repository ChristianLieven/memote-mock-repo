...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "ChristianLieven/memote-mock-repo" ]]; then
...
echo "Your new report will be visible at https://ChristianLieven.github.io/memote-mock-repo in a moment."
